package kurs.udemyjava.streams.flatmap;
...
public class FlatMapApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lotteryNumbersSet);
        ...
        List<String> availableCarBrands = carDealerships.stream()
                .flatMap(carDealership -> carDealership.getCarBrands().stream())
                .distinct()
                .collect(Collectors.toList());
        System.out.println(availableCarBrands);
