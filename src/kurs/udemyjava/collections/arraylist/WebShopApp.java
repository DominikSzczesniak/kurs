package kurs.udemyjava.collections.arraylist;
...
public class WebShopApp {
    public static void main(String[] args) {
        ...
        products.add(new Product("Earbud", 39.99, "Extremely clear sound."));
        products.add(new Product("Earbud", 39.99, "Extremely clear sound."));

        products.add(1, new Product("36 AAA batteries", 10.99, "High-performance alkaline batteries"));
//        products.remove(2);
        products.remove(new Product("Earbud", 39.99, "Extremely clear sound."));
